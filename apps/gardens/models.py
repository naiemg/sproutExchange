...
class Garden(models.Model):
    ...
    #sponsor_deadline = models.DateField(auto_now_add=False, default=datetime.date(datetime.now())+timedelta(days=14))
...
class Tier(models.Model):
    ...
    estimated_harvest = models.DateField(auto_now_add=False)
